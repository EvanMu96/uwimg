// credit to https://github.com/DiaaZiada/Uwimg#image-resizing
// implementation of resizing are less funny
// i just copy this file from the previous mentioned repo
